...
namespace ProRunners.AlliedVision
{
    ...
    public class VimbaHelper
    {
        ...
        /// </summary>
        private AVT.VmbAPINET.Camera m_Camera = null;
        ...
        public Bitmap AcquireSingleImage()
        {
            Frame frame = null;
            try
            {
                this.m_Camera.AcquireSingleImage(ref frame, 2000);
            }
            catch { }

            return ConvertSingleFrame(frame);
        }
        ...
        private Bitmap ConvertFrameContinous(Frame frame)
        {
            if (null == frame)
            {
                return null;
        ...
        private static Bitmap ConvertSingleFrame(Frame frame)
        {
            if (null == frame)
            {
                return null;
        ...
        private void OnFrameReceived(Frame frame)
        {
            try
            {
                ...
                Bitmap image = ConvertFrameContinous(frame);
